    ...
    <div class="main-content">
        <div>
            <div class="header-info">
                ...
                <button id="back-home-btn">BACK HOME</button>
                <button id="theme-btn-header">Themes</button>
      ...
      <section id="publication">
        ...
        <form id="create-article-form" enctype="multipart/form-data">
          <div class="form-group">
            ...
            <input type="text" id="article-title" placeholder="Enter the article title" required />
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <input type="file" id="article-cover" accept="image/*" required />
          </div>
          <div class="form-group">
            <label for="article-content">Content:</label>
            <textarea id="article-content" placeholder="Enter the article content" rows="6" required></textarea>
          </div>
